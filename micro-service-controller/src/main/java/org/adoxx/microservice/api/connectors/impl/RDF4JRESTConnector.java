...
public class RDF4JRESTConnector extends SyncConnectorA {

    @Override
    public String getName() {
        return "RDF4J Triplestore Connector";
    }

    @Override
    public JsonObject getDescription() {
        return Json.createObjectBuilder()
            .add("en", "Get data from an Eclipse RDF4J triplestore")
            .add("de", "Get data from an Eclipse RDF4J triplestore")
            .build();
    }
    ...
    public void start(JsonObject startConfiguration) throws Exception {
        ...
        if(endpoint.isEmpty()) throw new Exception("RDF4J endpoint not provided");
    }
    ...
    public JsonObject performCall(JsonObject configuration) throws Exception {
        ...
        htmlHeaderList.add(new String[]{"Accept", "application/sparql-results+json"});
        String resultJsonS = new String(Utils.sendHTTP(endpoint, "GET", "query="+URLEncoder.encode(sparqlQuery, "UTF-8"), htmlHeaderList, true, true).data, "UTF-8");
    ...
    public static void main(String[] argv) throws Exception{
        RDF4JRESTConnector connector = new RDF4JRESTConnector();
        try{
